 ...
 */
public class JDialog_ExpTraGen extends javax.swing.JDialog
{
    ...
    {
        JDialog_ExpTraGen generator = new JDialog_ExpTraGen(parent, modal, environmentParameter, crs);
    ...
    private JDialog_ExpTraGen(java.awt.Frame parent, boolean modal, EnvironmentParameter environmentParameter, CoordinateReferenceSystem crs)
    {
        super(parent, modal);
        initComponents();
        ...
        this.setTitle("Exponential distribution trajectory generating parameters set");
    ...
    private void initComponents() {
        ...
        jFormattedTextField_beta = new javax.swing.JFormattedTextField();
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(levyflight.LevyFlightApp.class).getContext().getResourceMap(JDialog_ExpTraGen.class);
        ...
        getContentPane().add(jFormattedTextField_velocity, new org.netbeans.lib.awtextra.AbsoluteConstraints(80, 80, 92, -1));
        ...
        getContentPane().add(jSeparator1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 110, 565, -1));
        ...
        getContentPane().add(jLabel9, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 128, -1, -1));

        jFormattedTextField_beta.setFormatterFactory(new javax.swing.text.DefaultFormatterFactory(new javax.swing.text.NumberFormatter(new java.text.DecimalFormat("#0.0###############"))));
        jFormattedTextField_beta.setText(resourceMap.getString("jFormattedTextField_beta.text")); // NOI18N
        jFormattedTextField_beta.setName("jFormattedTextField_beta"); // NOI18N
        getContentPane().add(jFormattedTextField_beta, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 124, 79, -1));

        jLabel10.setText(resourceMap.getString("jLabel10.text")); // NOI18N
        jLabel10.setName("jLabel10"); // NOI18N
        getContentPane().add(jLabel10, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 128, -1, -1));
        ...
        getContentPane().add(jFormattedTextField_xBottom, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 124, 79, -1));
        ...
        getContentPane().add(jLabel_top, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 230, 110, -1));

        jLabel_left.setText(resourceMap.getString("jLabel_left.text")); // NOI18N
        jLabel_left.setName("jLabel_left"); // NOI18N
        getContentPane().add(jLabel_left, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 260, 110, -1));

        jLabel_right.setText(resourceMap.getString("jLabel_right.text")); // NOI18N
        jLabel_right.setName("jLabel_right"); // NOI18N
        getContentPane().add(jLabel_right, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 260, 110, -1));

        jLabel_bottom.setText(resourceMap.getString("jLabel_bottom.text")); // NOI18N
        jLabel_bottom.setName("jLabel_bottom"); // NOI18N
        getContentPane().add(jLabel_bottom, new org.netbeans.lib.awtextra.AbsoluteConstraints(70, 280, 130, -1));
        ...
        getContentPane().add(jFormattedTextField_left, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 260, 110, -1));
        ...
        getContentPane().add(jFormattedTextField_right, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 260, 100, -1));
        ...
        getContentPane().add(jLabel_spanLat, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 470, 240, -1));

        jLabel_spanLon.setText(resourceMap.getString("jLabel_spanLon.text")); // NOI18N
        jLabel_spanLon.setName("jLabel_spanLon"); // NOI18N
        getContentPane().add(jLabel_spanLon, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 470, 270, -1));
        ...
        getContentPane().add(jFormattedTextField_pointLeft, new org.netbeans.lib.awtextra.AbsoluteConstraints(230, 410, 110, -1));
        ...
        getContentPane().add(jFormattedTextField_pointRight, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 410, 100, -1));
        ...
        getContentPane().add(jTextField_filePath, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 670, 282, -1));
    ...
    {//GEN-HEADEREND:event_jButton_okActionPerformed
        try
        {
            ...
            double beta = Double.parseDouble(this.jFormattedTextField_beta.getText());
            if (beta <= 0)
            {
            ...
            if (useRegionLimit && useSameStartPoint)
            {
                ...
                generator = new ExpTraGen(xBottom, beta, startNode, velocity, traNum, nodeNum, regionLimit, this.populationConstraint, polygonRegionConstraint);
            } else if (!useRegionLimit && useSameStartPoint)
            {
                Node startNode = new Node(startX, startY, startTime);
                generator = new ExpTraGen(xBottom, beta, startNode, velocity, traNum, nodeNum, this.populationConstraint, polygonRegionConstraint);
            } else if (useRegionLimit && !useSameStartPoint)
            {
                ...
                generator = new ExpTraGen(xBottom, beta, startPointLimit, startTime, velocity, traNum, nodeNum, regionLimit, this.populationConstraint, polygonRegionConstraint);
            } else
            {
                generator = new ExpTraGen(xBottom, beta, startPointLimit, startTime, velocity, traNum, nodeNum, this.populationConstraint, polygonRegionConstraint);
            }
...
//    }
    ...
    private javax.swing.JFormattedTextField jFormattedTextField_beta;
