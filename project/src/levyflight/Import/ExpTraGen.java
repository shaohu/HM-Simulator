 ...
 * @author Tiger Shao
 */
public class ExpTraGen extends TrajectoryGenerator
{
     ...
     * @throws Exception
     */
    public ExpTraGen(double xBottom, double beta, Node startNode, double flightSpeed, int totalNumToGen, int nodesPerTra, TC_Population PopulationConstraint,TC_PolygonRegion PolygonRegionConstraint) throws Exception
    {
        if (beta <= 0)
        {
     ...
     * @throws Exception
     */
    public ExpTraGen(double xBottom, double beta, Node startNode, double flightSpeed, int totalNumToGen, int nodesPerTra, MBR regionLimit, TC_Population PopulationConstraint,TC_PolygonRegion PolygonRegionConstraint) throws Exception
    {
        if (beta <= 1.000000000)
        {
     ...
     * @throws Exception
     */
    public ExpTraGen(double xBottom, double beta, MBR startPointRegion, Calendar startTime, double flightSpeed, int totalNumToGen, int nodesPerTra, TC_Population PopulationConstraint,TC_PolygonRegion PolygonRegionConstraint) throws Exception
    {
        if (beta <= 0.000000000)
        {
            throw (new Exception("指数项不能小于或等于1！"));
     ...
     * @throws Exception
     */
    public ExpTraGen(double xBottom, double beta, MBR startPointRegion, Calendar startTime, double flightSpeed, int totalNumToGen, int nodesPerTra, MBR regionLimit, TC_Population PopulationConstraint,TC_PolygonRegion PolygonRegionConstraint) throws Exception
    {
        if (beta <= 0.000000000)
        {
            throw (new Exception("指数项不能小于或等于1！"));
